"""
Train SASRec (Self-Attentive Sequential Recommendation) on Amazon dataset.
...
def main(config_path: str):
    ...
    trainer = SASRecTrainer(model, trainer_cfg, device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="configs/sasrec_config.yaml")
